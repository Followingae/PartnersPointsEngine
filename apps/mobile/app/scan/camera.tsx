      ...
      <View style={{ paddingTop: insets.top + 14, paddingHorizontal: SP.gutter }}>
        <View style={{ flexDirection: 'row', backgroundColor: 'rgba(255,255,255,.14)', borderRadius: 999, padding: 4 }}>
          <Pressable onPress={() => router.back()} style={{ flex: 1, alignItems: 'center', paddingVertical: 10 }}>
            <Text style={{ fontFamily: font(500), fontSize: 13, color: 'rgba(255,255,255,.7)' }}>My code</Text>
          </Pressable>
          <View style={{ flex: 1, alignItems: 'center', paddingVertical: 10, backgroundColor: '#fff', borderRadius: 999 }}>
            <Text style={{ fontFamily: font(600), fontSize: 13, color: C.ink }}>Scan a code</Text>
          </View>
        </View>
      </View>

      <View style={{ position: 'absolute', left: SP.gutter, right: SP.gutter, bottom: 120, alignItems: 'center' }}>
        <Text style={{ fontFamily: font(600), fontSize: 16, color: '#fff' }}>Point at the code on the till</Text>
        <Text style={{ marginTop: 8, fontFamily: font(500), fontSize: 13, color: '#fff' }}>Join codes, vouchers and pay-and-earn</Text>
        <Text style={{ marginTop: 10, textAlign: 'center', fontFamily: font(500), fontSize: 12, color: 'rgba(255,255,255,.6)' }}>
      ...
      {manual ? (
        <View style={{ position: 'absolute', left: SP.gutter, right: SP.gutter, bottom: 36 + insets.bottom }}>
          <TextInput
            ...
            style={{
              ...
              fontFamily: font(600), fontSize: 15, color: '#fff', letterSpacing: 1.2,
            }}
          />
          <View style={{ flexDirection: 'row', gap: 12, marginTop: 12 }}>
            ...
            >
              <Text style={{ fontFamily: font(600), fontSize: 14, color: '#fff' }}>Cancel</Text>
            </Pressable>
            <Pressable
              onPress={submit}
              style={{ flex: 1, backgroundColor: '#fff', borderRadius: 18, paddingVertical: 15, alignItems: 'center' }}
            >
              <Text style={{ fontFamily: font(600), fontSize: 14, color: C.ink }}>Continue</Text>
            </Pressable>
          </View>
        </View>
      ) : (
        <View style={{ position: 'absolute', left: SP.gutter, right: SP.gutter, bottom: 36 + insets.bottom, flexDirection: 'row', gap: 12 }}>
          ...
          >
            ...
            <Text style={{ fontFamily: font(600), fontSize: 14, color: '#fff' }}>Torch</Text>
          </View>
          <Pressable
            onPress={() => setManual(true)}
            style={{ flex: 1, backgroundColor: '#fff', borderRadius: 18, paddingVertical: 15, alignItems: 'center', justifyContent: 'center' }}
          >
            <Text style={{ fontFamily: font(600), fontSize: 14, color: C.ink }}>Enter code</Text>
          </Pressable>
        </View>
      )}
