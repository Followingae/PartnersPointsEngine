...
import { Building2, ExternalLink, MapPin, SlidersHorizontal } from 'lucide-react';
...
import {
  getBrandModules, getBrandsDirectory, manageBrand, setBrandModules,
  type BrandDirectoryRow, type BrandModules,
} from '@/lib/api';
                  ...
                  <tr key={b.id} className="hover:bg-muted/40">
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex justify-end gap-2">
                        <Button size="sm" variant="ghost" onClick={() => router.push(`/brands/${b.id}/locations`)}><MapPin size={14} /> Locations</Button>
